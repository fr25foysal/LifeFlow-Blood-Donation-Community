        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-xl text-white">
            ...
            <div className='flex gap-5 justify-center text-white'>
                <button className="btn btn-accent text-white hover:text-white hover:bg-transparent border-2">Join as a Donor <MdVolunteerActivism /></button>
                <button className="btn btn-outline hover:bg-accent hover:border-transparent text-white hover:text-white ">Search Donors <FaSearch/></button>
            </div>
